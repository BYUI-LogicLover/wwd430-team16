  ...
  return (
    <div className="bg-[#f8f8f8] text-[#343434]">
      <div className="mx-auto max-w-md px-6 py-16">
        <h1 className="font-[family-name:var(--font-montserrat)] text-3xl font-bold">Create account</h1>
        <p className="mt-2 opacity-70">Join the marketplace.</p>
        ...
        <p className="mt-6 text-sm opacity-70">
          ...
          <Link href="/login" className="font-medium text-[#28582e]">
            Sign in
          </Link>
        </p>
      </div>
